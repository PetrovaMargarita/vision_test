...
$('.pop-up-button').click(function () {
    setTimeout(function () {
        $("html, body").animate({scrollTop: $(".form-container").offset().top}, 400)
    }, 500)
...
(function (factory) {
    ...
    var dictionary = {
        ...
        es: {days: "dias", hours: "horas", min: "minutos", sec: "segundos"},
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            var $this = $(this);
            var data = $this.data();
            var defs, opt, i, css, language, left, ulhtml, style, dhtml1, dhtml2, dot2, maxWidth, captionSize,
                fsStyleVal, fsStyle, thtml, marginRight, dhtml, $digits, dif, vals, limits;
            if (data.intervalId) {
...
let regPhone = /^\+?([0-9]{2})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{3})[-. ]?([0-9]{2})[-. ]?([0-9]{2})$/;
let regName = /^[a-zA-Z]+$/;
...
const error = {
    ...
    regName: 'Ввведите имя на латинице',
    regPhone: 'Ввведите корректный номер',
    maxlength: "Максимальное количество 15 символов",
    minlength: "Минимальное количество 3 символа",
};
const validationSubmit =
    ...
    $("#order_form").validate({
        ...
        highlight: function (element, errorClass, validClass) {
            $(element).parents("div.floating").addClass(errorClass).removeClass(validClass); //добавляем ошибки
        },
        ...
        submitHandler: function (form) {
            ...
            document.querySelector(".tab-2").style.display =
                "block";
            document.querySelector(".tab-1").style.display =
                "none";
