!function (s, m) {
    ...
    s.cookie = function (e, a, t) {
        ...
        for (var i, o = (t = a || s.cookie.defaults || {}).raw ? c : l, d = m.cookie.split("; "), u = 0; i = d[u] && d[u].split("="); u++) if (o(i.shift()) === e) return o(i.join("="));
        return null
    }, s.cookie.defaults = {}
}(jQuery, document);
var months_localized = {
    ...
    var a = e.shift, t = e.mode, r = void 0 === t ? "dtime_nums" : t, n = e.old, t = void 0 === n || n, n = e.euFormat,
        n = void 0 === n ? 1 : n, e = e.index, e = void 0 === e ? 0 : e;
...
function getLocalizedEntity(e, a) {
    ...
    var t = window.lang_locale || "en",
        a = {month: {dict: months_localized, method: "getMonth"}, day: {dict: days_localized, method: "getDay"}}[a];
    return a ? a.dict[a.dict[t] ? t : "en"][e[a.method]()] : "Unknown entity"
}

function dtime_nums(e, a) {
    a = new AdcLandDate({shift: e, euFormat: a});
    document.write(a.toString())
}

function dtime(e) {
    e = new AdcLandDate({mode: "dtime", shift: e});
    document.write(e.toString())
}

function dtimes(e) {
    e = new AdcLandDate({mode: "dtimes", shift: e});
    document.write(e.toString())
}
...
AdcLandDate.prototype._compileDate = function (e) {
    ...
    return {
        dtime_nums: function () {
            ...
            return {day: r._day.getDate(), month: r._getLocalizedEntity(r._day, "month")}
        }, ryear: function () {
            return {year: r._day.getFullYear()}
        }, rstart: function () {
            ...
            var a = 16 <= e ? 16 : e, t = new Date(parseInt($.cookie("randDate"))),
    ...
    var e = this, a = this.getDate(this._indexOfCollection), t = {
        dtime_nums: function () {
    ...
    $.cookie("randDate") || $.cookie("randDate", (new Date).getTime() - 2592e6, {expires: 1})
}, AdcLandDate.init(), $(function () {
    $.fn.adcLandDate = function (n) {
        var i = this;
        i.each(function (e) {
            var a = i.eq(e), t = a.attr("data-date-shift"), r = a.attr("data-date-eu"),
                r = new AdcLandDate({mode: n, shift: t, old: !1, index: e, euFormat: r});
            a.text(r.toString())
        })
